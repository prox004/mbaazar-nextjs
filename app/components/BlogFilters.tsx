    ...
    <div className="space-y-6 w-full max-w-4xl mx-auto mb-10 px-4">
      ...
      <form onSubmit={handleSearchSubmit} className="relative w-full">
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-full border border-zinc-200 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 transition-all text-sm text-zinc-800 bg-white shadow-sm placeholder-zinc-400"
        />
        ...
        <button
          type="submit"
          className="absolute right-2 top-1/2 -translate-y-1/2 bg-zinc-950 text-white px-5 py-1.5 rounded-full text-xs font-semibold hover:bg-red-600 transition-colors"
        >
      ...
      <div className="flex flex-wrap gap-2 justify-center items-center">
        <button
          ...
          className={`px-5 py-2 rounded-full text-xs font-semibold tracking-wide transition-all border cursor-pointer ${
            !activeCategory
