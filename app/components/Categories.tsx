    ...
    <section className="py-12 sm:py-16 bg-white text-black w-full overflow-hidden">
      <div className="w-full px-4 sm:px-6 lg:px-12">
        ...
        <div className="mb-10 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-zinc-950 flex justify-center gap-x-2 flex-wrap">
            <SplitText text="Browse By" tag="span" />{" "}
            <SplitText text="Category" tag="span" className="text-red-600" />
          </h2>
        </div>
